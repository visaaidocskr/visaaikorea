...
export function TravelAuthScene() {
  ...
  return (
    <div
      aria-hidden="true"
      className="relative isolate min-h-56 overflow-hidden rounded-[2rem] border border-white/15 bg-slate-950 px-6 py-7 shadow-2xl shadow-blue-950/25 sm:min-h-72 md:min-h-[35rem] md:px-10 md:py-10"
    >
      ...
      <div className="relative z-10 flex items-center gap-2 text-xs font-bold uppercase tracking-[0.22em] text-blue-200">
        <span className="h-2 w-2 rounded-full bg-cyan-300 shadow-[0_0_14px_3px_rgba(103,232,249,0.55)]" />
        {t("auth.journey")}
      </div>
      ...
      <svg
        viewBox="0 0 500 330"
        className="absolute inset-x-0 bottom-0 z-10 h-[72%] w-full md:h-[66%]"
        fill="none"
      ...
      >
        ...
        <path d="M73 261C153 267 158 158 252 179C331 198 326 72 433 71" stroke="#60A5FA" strokeOpacity=".2" strokeWidth="30" />
        <path
          className="auth-route"
          d="M73 261C153 267 158 158 252 179C331 198 326 72 433 71"
      ...
      <div className="absolute bottom-5 right-6 z-20 rounded-2xl border border-white/15 bg-white/10 px-3 py-2 backdrop-blur-md md:bottom-9 md:right-9">
